...
// Componente para "Cambiar Práctica"
...
// Componente para "Inscribir Práctica"
const InscribirPractica = () => {
    return (
        <div className={style.cambPrac}>
            <h1 className={style.title}>INSCRIBIR PRÁCTICA</h1>
            <input className={style.input} type="email" placeholder="EMAIL" />
            <input className={style.input} type="text" placeholder="Práctica NUEVA" />
