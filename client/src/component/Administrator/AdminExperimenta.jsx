    ...
    return (
        ...
        <div className={style.conteiner}>
            <div className={style.cambPrac}>
                ...
                <input className={style.input} type="text" placeholder='Practica NUEVA' />

                <button class={style.Btn}>Edit
                    <svg class={style.svg} viewBox="0 0 512 512">
